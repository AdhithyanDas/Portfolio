...
function Home() {
    return (
        <>
            <div className='container-fluid pt-5' id='home' style={{ minHeight: "70vh" }}>
                <Row>
                    <Col sm={12} md={12}>
